...
void main() {
  ...
  group('InMemoryNewsDataSource', () {
    ...
    group('getFeed', () {
      ...
      test('returns stubbed feed (PostCategory.study)', () {
        expect(
          newsDataSource.getFeed(category: Category.study),
          completion(feedHaving(blocks: studyFeedBlocks)),
        );
      });

      test('returns stubbed feed (PostCategory.study)', () {
        expect(
          newsDataSource.getFeed(category: Category.business),
          completion(feedHaving(blocks: businessFeedBlocks)),
        );
      });
    ...
    group('getArticle', () {
      ...
      test(
        ...
        final item = studyNewsItems.first;
        expect(
    ...
    group('getRelatedArticles', () {
      ...
      test('returns related articles when article exists', () {
        final item = businessItems.first;
