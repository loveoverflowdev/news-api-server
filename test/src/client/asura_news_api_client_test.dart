...
void main() {
  ...
  group('AsuraNewsApiClient', () {
    late http.Client httpClient;
    late AsuraNewsApiClient apiClient;
    ...
    group('localhost constructor', () {
      ...
      test('has correct baseUrl', () async {
        ...
        final apiClient = AsuraNewsApiClient.localhost(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('default constructor', () {
      test('can be instantiated (no params).', () {
        expect(
          () => AsuraNewsApiClient(tokenProvider: tokenProvider),
          returnsNormally,
        );
      });
      ...
      test('has correct baseUrl.', () async {
        ...
        final apiClient = AsuraNewsApiClient(
          httpClient: httpClient,
          tokenProvider: tokenProvider,
        );
    ...
    group('getArticle', () {
      ...
      test(
          'throws AsuraNewsApiMalformedResponse '
        ...
        expect(
          ...
          throwsA(isA<AsuraNewsApiMalformedResponse>()),
        );
      });

      test(
          'throws AsuraNewsApiRequestFailure '
        ...
        expect(
          () => apiClient.getArticle(id: articleId),
          throwsA(
            isA<AsuraNewsApiRequestFailure>()
