...
/// {@template asura_news_api_malformed_response}
/// An exception thrown when there is a problem decoded the response body.
/// {@endtemplate}
class AsuraNewsApiMalformedResponse implements Exception {
  /// {@macro asura_news_api_malformed_response}
  const AsuraNewsApiMalformedResponse({required this.error});

  /// The associated error.
  final Object error;
}

/// {@template asura_news_api_request_failure}
/// An exception thrown when an http request failure occurs.
/// {@endtemplate}
class AsuraNewsApiRequestFailure implements Exception {
  /// {@macro asura_news_api_request_failure}
  const AsuraNewsApiRequestFailure({
...
/// {@template asura_news_api_client}
/// A Dart API client for the Asura News API.
/// {@endtemplate}
class AsuraNewsApiClient {
  /// Create an instance of [AsuraNewsApiClient] that integrates
  /// with the remote API.
  ///
  /// {@macro asura_news_api_client}
  AsuraNewsApiClient({
  ...
  Future<ArticleResponse> getArticle({
    ...
    if (response.statusCode != HttpStatus.ok) {
      throw AsuraNewsApiRequestFailure(
        body: body,
  ...
  Map<String, dynamic> json() {
    try {
      ...
      Error.throwWithStackTrace(
        AsuraNewsApiMalformedResponse(error: error),
        stackTrace,
      );
    }
  }
